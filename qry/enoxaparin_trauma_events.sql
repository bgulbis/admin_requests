SELECT DISTINCT
	...
	CV_ADMIN_SITE.DISPLAY AS ADMIN_SITE
FROM
	CE_MED_RESULT,
	CLINICAL_EVENT,
	CODE_VALUE CV_ADMIN_SITE,
	CODE_VALUE CV_EVENT,
	...
	ENCOUNTER
WHERE
	CLINICAL_EVENT.EVENT_CD = 37556844
	...
	AND (
		...
		AND ENCNTR_LOC_HIST.LOC_NURSE_UNIT_CD IN (4356, 5441, 1542800, 16163788, 2428498395)
	...
	AND (
		...
		AND CE_MED_RESULT.ADMIN_SITE_CD = CV_ADMIN_SITE.CODE_VALUE
	)
	AND (
