...
--		pi_from_gmt(MIN(LOC_GROUP.BEG_EFFECTIVE_DT_TM), (pi_time_zone(1, @Variable('BOUSER')))) AS ARRIVE_DATETIME,
...
SELECT DISTINCT
	...
	pi_from_gmt(PREV_UNIT.BEG_EFFECTIVE_DT_TM, (pi_time_zone(1, @Variable('BOUSER')))) AS TRANSFER_DATETIME,
	pi_get_cv_display(PREV_UNIT.PREV_NURSE_UNIT_CD) AS TRANSFER_FROM,
	pi_get_cv_display(PREV_UNIT.LOC_NURSE_UNIT_CD) AS TRANSFER_TO,
