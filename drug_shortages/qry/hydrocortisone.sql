WITH HCORT_ORDERS AS (
	...
	WHERE
		...
		AND ORDERS.CATALOG_CD = 9903883 -- hydrocortisone
	...
	FROM
		...
		ORDER_DETAIL
	WHERE
		HCORT_ORDERS.ORDER_ID = ORDER_DETAIL.ORDER_ID
), ORD_DETAIL_PIVOT AS (
...
FROM 
	...
	ORD_DETAIL_PIVOT
WHERE
	HCORT_ORDERS.ORDER_ID = ORD_DETAIL_PIVOT.ORDER_ID
