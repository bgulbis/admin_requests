...
```{r}
glm(recur_gi_bleed ~ age + female + bmi + afib + cad + dm + cva + low_inr, family = "binomial", data = df) %>%
    tidy() %>%
    knitr::kable(digits = 3)
```
...
```{r}
glm(pump_thrombosis ~ age + female + bmi + afib + cad + dm + cva + low_inr, family = "binomial", data = df) %>%
    tidy() %>%
    knitr::kable(digits = 3)
```
...
```{r}
glm(isch_cva ~ age + female + bmi + afib + cad + cad + dm + cva + low_inr, family = "binomial", data = df) %>%
    tidy() %>%
    knitr::kable(digits = 3)
```
...
```{r}
glm(pump_thromb_cva ~ age + female + bmi + afib + cad + dm + cva + low_inr, family = "binomial", data = df) %>%
    tidy() %>%
    knitr::kable(digits = 3)
```
...
```{r}
glm(hemor_cva ~ age + female + bmi + afib + cad + dm + cva + low_inr, family = "binomial", data = df) %>%
    tidy() %>%
    knitr::kable(digits = 3)
```
...
```{r}
glm(isch_cva ~ age + female + bmi + afib + cad + dm + cva + low_inr, family = "binomial", data = df) %>%
    stepAIC(direction = "backward", trace = FALSE) %>%
    tidy() %>%
    knitr::kable(digits = 3)
```
